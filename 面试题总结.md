...
5. 集群容错: 6种， failover， failfast，failsafe，failback，forking cluster broadcast cluster
6. 负载均衡策略: 随机 轮询 最少活跃数 一致性hash
7. provider、consumer、registry、monitor、container
